...
class remove_child_frames_node(Node):
    def __init__(self):
        ...
        tf_pub = self.create_publisher(msg_type=TFMessage, topic='tf_out', qos_profile=QoSProfile(depth=1))
        ...
        self.create_subscription(msg_type=TFMessage, topic="tf", callback=tf_cb, qos_profile=qos_profile_system_default)
        ...
        self.create_subscription(
            msg_type=TFMessage, topic="tf_static", callback=tf_static_cb, qos_profile=qos_profile_system_default
        )
